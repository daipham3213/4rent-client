...
const Comment: React.FC<IComment> = ({
  ...
  const { avatar, username, fistName, lastName } = createdBy;
      ...
      <div className="relative w-full overflow-hidden">
        ...
        <div className="flex w-full flex-row gap-3">
          <Avatar
            src={avatar}
            alt={username}
            aria-label={`avatar-${fistName}-${lastName}`}
            className="pt-5"
          >
            {username}
          </Avatar>
...
const Post: React.FC<IPost> = ({
  ...
  const { lastName, fistName, avatar, username } = createdBy;
    ...
    <div className="flex flex-col gap-2 rounded border border-gray-300 bg-gray-100 py-2 dark:border-gray-600 dark:bg-gray-700">
      ...
      <div className="flex flex-row items-center justify-between gap-2 px-4">
        <div className="flex flex-row items-center gap-4">
          ...
          <div>
            <p className="text-base font-semibold">{`${fistName} ${lastName}`}</p>
